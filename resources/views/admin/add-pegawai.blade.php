            ...
            <div class="card-body">
                ...
                <form action="/pegawai/store" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="jabatan" class="form-control" id="nama" placeholder="Jabatan" value="" required>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="umur" class="form-control" id="nama" placeholder="Umur Pegawai" value="" required>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="alamat" class="form-control" id="nama" placeholder="Alamat Lengkap" value="" required>
